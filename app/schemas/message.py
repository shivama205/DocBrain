...
class MessageSource(BaseModel):
    ...
    content: str = Field(
        ..., description="Relevant content from the document or question"
    )
    ...
    chunk_index: Optional[int] = Field(
        None, description="Index of the chunk in the document"
    )
    ...
    answer: Optional[str] = Field(
        None, description="The answer for the matched question"
    )
    answer_type: Optional[str] = Field(
        None, description="Type of answer (DIRECT, SQL_QUERY, etc.)"
    )
...
class MessageBase(BaseModel):
    ...
    content_type: MessageContentType = Field(
        ..., description="Type of message (TEXT/IMAGE/AUDIO/VIDEO/DOCUMENT)"
    )
...
class MessageResponse(MessageBase):
    ...
    kind: MessageKind = Field(
        ..., description="Kind of message (USER/ASSISTANT/SYSTEM)"
    )
    ...
    knowledge_base_id: str = Field(
        ..., description="ID of the knowledge base this message belongs to"
    )
    sources: Optional[List[MessageSource]] = Field(
        None, description="Source documents used for assistant's response"
    )
    message_metadata: Optional[Dict[str, Any]] = Field(
        None, description="Additional metadata including routing information"
    )
    status: MessageStatus = Field(
        ..., description="Status of the message (RECEIVED/PROCESSING/SENT/FAILED)"
    )
